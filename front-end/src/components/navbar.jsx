            ...
            <nav className='md:hidden fixed top-0 left-0 z-50 w-full'>
                ...
                <AnimatePresence>
                    {isOpen && (
                        ...
                        >
                            <a  href="#inicio" className="text-yellow-300 font-semibold p-2">Início</a>
                            <a href="#contato" className="text-yellow-300 font-semibold p-2">Contato</a>
                            <a href="#depoimentos" className="text-yellow-300 font-semibold p-2">Depoimentos</a>
                            <a href="#imoveis" className="text-yellow-300 font-semibold p-2">Imóveis em Destaque</a>
                            <a href="#localizacao"  className="text-yellow-300 font-semibold p-2">Localização</a>
                        </motion.div>
                    )}
                </AnimatePresence>
            </nav>
                ...
                <div className="w-full bg-black h-20 px-4 relative z-50 flex justify-center">
                    <div className='flex w-full justify-between items-center max-w-[1000px]'>
                        ...
                        <div className='gap-4 m-4'>
                            ...
                            <a href="#depoimentos" className="text-yellow-300 font-semibold text-sm p-3 mr-4 hover:text-yellow-600 hover:bg-amber-300 duration-300 rounded-2xl">Depoimentos</a>
                            <a href="#imoveis" className="text-yellow-300 font-semibold text-sm p-3 mr-4 hover:text-yellow-600 hover:bg-amber-300 duration-300 rounded-2xl">Imóveis em Destaque</a>
                            <a href="#localizacao" className="text-yellow-300 font-semibold text-sm p-3 mr-4 hover:text-yellow-600 hover:bg-amber-300 duration-300 rounded-2xl">Localização</a>
                        </div>
                    </div>
                </div>
            </nav>
